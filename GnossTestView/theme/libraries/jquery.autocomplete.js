...
; (function ($) {
    ...
    $.Autocompleter = function (input, options) {
        ...
        function pintarSeleccionado(textbox, resultado) {
            ...
            if (textbox.attr('id') == 'finderSection' || textbox.attr('id') == 'txtBusquedaPrincipal') {
                /*Si es el buscador de una pÃƒÂ¡gina de busqueda o el metabuscador superior, autocompleta con "" */
                resultado = '"' + resultado + '"';
            }
        ...
        var normalize = (function () {
            var from = "ÃƒÆ’Ãƒâ‚¬ÃƒÂÃƒâ€žÃƒâ€šÃƒË†Ãƒâ€°Ãƒâ€¹ÃƒÅ ÃƒÅ’ÃƒÂÃƒÂÃƒÅ½Ãƒâ€™Ãƒâ€œÃƒâ€“Ãƒâ€Ãƒâ„¢ÃƒÅ¡ÃƒÅ“Ãƒâ€ºÃƒÂ£Ãƒ ÃƒÂ¡ÃƒÂ¤ÃƒÂ¢ÃƒÂ¨ÃƒÂ©ÃƒÂ«ÃƒÂªÃƒÂ¬ÃƒÂ­ÃƒÂ¯ÃƒÂ®ÃƒÂ²ÃƒÂ³ÃƒÂ¶ÃƒÂ´ÃƒÂ¹ÃƒÂºÃƒÂ¼ÃƒÂ»Ãƒâ€˜ÃƒÂ±Ãƒâ€¡ÃƒÂ§",
    ...
    function QuitarContadores(cadena) {
        ...
        // Obtener la cadena entre parÃƒÂ©ntesis
        ...
        // Si es un entero, quitamos los parÃƒÂ©ntesis
